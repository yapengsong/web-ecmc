...
angular.module('eayun.unit')
    .controller('unitDetailCtrl', ['model','ServiceunitService','$scope','eayunModal', function (model,ServiceunitService,$scope,eayunModal) {
        var vm = this;
...
vm.chekpassfag=true;
        vm.downzip=function(){
                    ...
                    $("#excel-export-iframe").attr("src", "/api/ecmc/record/downzip.do?id="+vm.model.applyId);
            vm.chekpassfag=false;
