...
angular.module('eayun.image')
    .controller('UnClassEditCtrl', ['$scope','SysCode','unclassifiedimageService','item','HomeCommonService',function ($scope,SysCode,unclassifiedimageService,item,HomeCommonService) {
        var vm = this;

        vm.item = angular.copy(item,{});
        vm.isCheckName = true;
        vm.minDiskValue = 20;
        vm.item.imageIspublic='3';
        ...
        unclassifiedimageService.getAllVmSysList().then(function (data) {
            vm.sysList = data;
        });
       ...
       /* vm.checkName = function(name){
            unclassifiedimageService.checkName(vm.item).then(function (data) {
