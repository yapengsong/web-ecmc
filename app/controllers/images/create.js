...
angular.module('eayun.image')
    .controller('CreateGlobalImageCtrl', ['$scope',  'HomeCommonService','GlobalService', 'eayunModal',  'toast','SysCode',
        function ($scope, HomeCommonService,GlobalService, eayunModal, toast,SysCode) {
            var vm = this;
            vm.imageItem = {
                'createType':'1',
                'file':[]
            ...
            GlobalService.getImageFormat().then(function(data){
                vm.imList = data;
            });
            ...
            $scope.commit = function () {
               ...
               if('1'==vm.imageItem.createType){
                ...
                GlobalService.createPublicImage(vm.imageItem).then(function (data) {
                   // $("#loadingBar").hide();
                    $scope.ok(data);
                }, function () {
                  //  $("#loadingBar").hide();
